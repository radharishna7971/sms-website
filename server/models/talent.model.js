		     ...
		     .then(function(results1) {
		    	 ...
		    	 db.knex.raw(' \
		  		       ...
		  		       .then(function(results2) {
		  		    	 ...
		  		    	 //callback(ob);
			  		    	 db.knex.raw(' \
			  		    			select c.`name` as creditname,DATE_FORMAT(c.release_date,"%d %b %Y") as release_date,r.`name` as rolename,c.estimatedBudget,c.box_office_income \
			 		  		    	from credit_talent_role_join cjoin \
			 		  		    	inner join credits c on c.id = cjoin.credit_id \
			 		  		    	inner join roles r on r.id = cjoin.role_id  \
			 		  		    	where cjoin.talent_id ='+talentId)
